...
import org.tensorflow.demo.models.DecisionTreeClassifier;
import org.tensorflow.demo.models.RandomForestClassifier;
...
//                        micButton.setImageDrawable(getResources().getDrawable(R.drawable.ic_baseline_mic_red));
...
//                        progress.setVisibility(View.INVISIBLE);
    ...
    private void record() {
        ...
        this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                micButton.setBackground(getResources().getDrawable(R.drawable.ic_baseline_mic_red));
                progress.setVisibility(View.VISIBLE);
        ...
        this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                micButton.setBackground(getResources().getDrawable(R.drawable.ic_baseline_mic_24));
                progress.setVisibility(View.INVISIBLE);
    ...
    private void recognize() {
        ...
        int out = decisionTreeClassifier.predict(X);
        //Log.v(LOG_TAG, "DTC Prediction: " + out);

        RandomForestClassifier randomForestClassifier = new RandomForestClassifier();
        final int rfout = randomForestClassifier.predict(X);
        //Log.v(LOG_TAG, "RFC Prediction: " + rfout);

//        this.runOnUiThread(new Runnable() {
//            @Override
//            public void run() {
//                Toast.makeText(SpeechActivity.this, "RFC Prediction: " + rfout, Toast.LENGTH_SHORT).show();
//            }
//        });
...
//        });
        ...
        this.runOnUiThread(new Runnable() {
            @Override
            public void run() {
                Intent resultIntent = new Intent(SpeechActivity.this, ResultActivity.class);
                resultIntent.putExtra("rfOutput", rfout);
