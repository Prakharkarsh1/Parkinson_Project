...
public class MFCC {
	...
	private final static int       n_mfcc       		= 20; // mfcc count
	private final static double    fMin                 = 0.0; //
	private final static int       n_fft                = 2048; // FFT size
	private final static int       hop_length           = 512; // Hop length
	private final static int	   n_mels               = 128; // mel band count

	private final static double    sampleRate           = 16000.0; // recording sample rate
